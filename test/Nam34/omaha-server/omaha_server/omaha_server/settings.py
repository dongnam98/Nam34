...
OMAHA_URL_PREFIX = 'http://10.2.64.104:9090' 
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

TEMPLATE_DEBUG = True

ALLOWED_HOSTS = ['10.2.64.104']
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', '10.2.64.104'),
...
REDIS_HOST = os.environ.get('REDIS_HOST', '10.2.64.104')
